...
const Sketch = () => {
    ...
    return (
        <div className="about fadeIn" style={{ backgroundColor: state.background, paddingBottom: "1em" }}>
            ...
            <p style={{ color: state.text, maxWidth: '100%', width: '20em', marginRight: '5%', marginLeft: '5%', textAlign: 'justify', fontSize: '1.5em', paddingTop: '1.5em' }}>We are manufacturers and wholesalers of premium paint brushes and tools in Coimbatore. With over 20+ years of experience in
